...
class ADF4351
{
  public:
    ...
    */
    ...
    void setfDirect(uint16_t R_divider, uint16_t INT_value,uint16_t MOD_value,uint16_t FRAC_value, uint8_t RF_DIVIDER_value, uint8_t PRESCALER_value, bool FRACTIONAL_MODE);
